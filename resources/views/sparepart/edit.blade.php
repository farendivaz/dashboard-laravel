        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="card card-info card-outline">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sparepart.update', ['sparepart' => $sparepart]) }}" method="post">
                            @csrf
                            @method('PATCH')
                            <div class="form-group">
                                <label for="kode_sparepart">Kode Barang</label>
                                <input type="text" name="kode_sparepart" class="form-control" id="kode_sparepart"
                                    value={{ $sparepart->kode_sparepart }} placeholder="Masukan Kode Barang" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jenis" class="form-control" id="jenis"
                                    value={{ $sparepart->jenis }} placeholder="Masukan Jenis Barang">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="brand" class="form-control" id="brand"
                                    value={{ $sparepart->brand }} placeholder="Masukan Nama Brand">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="harga" class="form-control" id="harga"
                                    value={{ $sparepart->harga }} placeholder="Masukkan Harga Barang">
