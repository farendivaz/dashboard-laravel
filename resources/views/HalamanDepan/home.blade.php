        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <!-- Panggil DB jumlah Status Selesai -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Di Proses</span>
                <!-- panggil db status proses -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <!-- panggil db status gagal -->
                <span class="info-box-number">90909</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
